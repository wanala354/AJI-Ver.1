...
function initializeDatabaseIfMissing() {
  ...
  // Define sheets schema for Version 2.1 (includes master lists and upgraded Users schema)
  const schema = {
...
// ----------------------------------------------------
function saveMasterItemGAS(tableName, oldName, newName, operatorUsername) {
  const ss = SpreadsheetApp.openById(SPREADSHEET_ID);
